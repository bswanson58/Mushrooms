...
namespace ReusableBits.Wpf.Behaviours {
    public class ScrollBarOpacity : Behavior<FrameworkElement> {
        ...
        public static readonly DependencyProperty FadeInAnimationProperty = DependencyProperty.Register(
            nameof( FadeInAnimation ), typeof( Storyboard ), typeof( ScrollBarOpacity ), new PropertyMetadata( null ));
        ...
        public static readonly DependencyProperty FadeOutAnimationProperty = DependencyProperty.Register(
            nameof( FadeOutAnimation ), typeof( Storyboard ), typeof( ScrollBarOpacity ), new PropertyMetadata( null ));
