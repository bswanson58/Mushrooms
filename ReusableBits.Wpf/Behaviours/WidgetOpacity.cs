...
namespace ReusableBits.Wpf.Behaviours {
    public class WidgetOpacity : Behavior<FrameworkElement> {
        ...
        public static readonly DependencyProperty TagNameProperty = DependencyProperty.Register(
            nameof( TagName ), typeof( string ), typeof( WidgetOpacity ), new PropertyMetadata( null, OnTagNameChanged ));
        ...
        public string TagName {
            get => GetValue( TagNameProperty ) as string ?? String.Empty;
            set => SetValue( TagNameProperty, value );
        }

        public static readonly DependencyProperty IsEnabledProperty = DependencyProperty.Register(
            nameof( IsEnabled ), typeof( bool ), typeof( WidgetOpacity ), new PropertyMetadata( true, OnEnabledChanged ));
        ...
        public static readonly DependencyProperty IsDisabledProperty = DependencyProperty.Register(
            nameof( IsDisabled ), typeof( bool ), typeof( WidgetOpacity ), new PropertyMetadata( false, OnEnabledChanged ));
        ...
        public static readonly DependencyProperty FadeInAnimationProperty = DependencyProperty.Register(
            nameof( FadeInAnimation ), typeof( Storyboard ), typeof( WidgetOpacity ), new PropertyMetadata( null ));
        ...
        public static readonly DependencyProperty FadeOutAnimationProperty = DependencyProperty.Register(
            nameof( FadeOutAnimation ), typeof( Storyboard ), typeof( WidgetOpacity ), new PropertyMetadata( null ));
