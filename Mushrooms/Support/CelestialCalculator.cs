...
namespace Mushrooms.Support {
    ...
    public class CelestialCalculator : ICelestialCalculator {
        ...
        */
        ...
        private void FindSunAndTwilightDataForDate( CelestialData data, DateTime dt, double tz, double glong, double glat ) {
            //
            //	this is my attempt to encapsulate most of the program in a function
            //	then this function can be generalized to find all the Sun events.
            //
            //
...
//            return outstring;
        ...
        private void FindMoonRiseAndSet( CelestialData data, DateTime dt, double tz, double glong, double glat ) {
            //
